  ...
  return (
    <>
      <Container>
        ...
        <Button data={'÷'} onClick={chooseOperationsHandler} operation>÷</Button>
        ...
        <Button data={'x'} onClick={chooseOperationsHandler} operation>x</Button>
        ...
        <Button data={'='} onClick={equalHandler} gridSpan={2} equals>=</Button>
      </Container>
    </>
  )
}
